"""
Django settings for simple_online_store project.
...
SECRET_KEY = 'p4nbvfa)-x_o*g+5q@@@val4v^6(+61ix8ewv#%y1$!jy_5g26'
...
WSGI_APPLICATION = 'simple_online_store.wsgi.application'
